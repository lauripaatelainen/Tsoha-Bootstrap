...
CREATE TABLE Ryhma(
    ...
    yllapitaja      integer         REFERENCES Kayttaja(id)
);

CREATE TABLE RyhmanJasenyys(
    kayttaja        integer         REFERENCES Kayttaja(id),
    ryhma           integer         REFERENCES Ryhma(id),
...
CREATE TABLE Kutsu(
    ryhma           integer         REFERENCES Ryhma(id),
    kutsuttu        integer         REFERENCES Kayttaja(id),
    viesti          text            NOT NULL,
...
CREATE TABLE Tykkays(
    kayttaja        integer         REFERENCES Kayttaja(id),
    julkaisu        integer         REFERENCES Julkaisu(id),
